...
cd $BASEDIR
cp ./modules/facts/dummy/facts_dummy_preprocess.py experiments/tlm.hector/input/tlm.hector.temperature.fair.temperature_climate.nc $PIPELINEDIR
cd $PIPELINEDIR
...
cd $PIPELINEDIR
. $RP_PILOT_SANDBOX/env/rp_named_env.rp.sh || true
python3 tlm_sterodynamics_project.py --pipeline_id tlm.hector.ocean.tlm.sterodynamics --nsamps 1 --scenario ssp585 --baseyear 2005 --pyear_start 2020 --pyear_end 2150 --pyear_step 10
