...
cd $PIPELINEDIR
# Define RP_PILOT_SANDBOX, temporary until we figure out how it's supposed to be defined
RP_PILOT_SANDBOX=$HOME/radical.pilot.sandbox/re.session.6169df4a-2f09-11ef-89d3-0242ac110002/pilot.0000
...
cd $PIPELINEDIR
. $RP_PILOT_SANDBOX/env/rp_named_env.rp.sh || true
python3 deconto16_AIS_project.py --nsamps 3 --pyear_start 2020 --pyear_end 2150 --pyear_step 10 --pipeline_id onemodule.deconto16.deconto16.AIS
