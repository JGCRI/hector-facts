...
cd $BASEDIR
cp ./modules/ipccar5/glaciers/ipccar5_glaciers_postprocess.py ./modules/ipccar5/glaciers/ReadFingerprint.py ./modules/ipccar5/glaciers/AssignFP.py ./modules/ipccar5/glaciers/read_locationfile.py ./modules-data/grd_fingerprints_data.tgz $PIPELINEDIR
cd $PIPELINEDIR
. $RP_PILOT_SANDBOX/env/rp_named_env.rp.sh || true
...
cd $BASEDIR
cp ./modules/ipccar5/icesheets/ipccar5_icesheets_postprocess.py ./modules/ipccar5/icesheets/AssignFP.py ./modules/ipccar5/icesheets/ReadFingerprint.py ./modules/ipccar5/icesheets/read_locationfile.py ./modules-data/grd_fingerprints_data.tgz $PIPELINEDIR
cd $PIPELINEDIR
. $RP_PILOT_SANDBOX/env/rp_named_env.rp.sh || true
tar -xvf grd_fingerprints_data.tgz 2> /dev/null; rm grd_fingerprints_data.tgz
...
cd $BASEDIR
cp ./modules/kopp14/glaciers/readMarzeion.py ./modules/kopp14/glaciers/kopp14_glaciers_preprocess.py ./modules-data/kopp14_glaciers_preprocess_data.tgz $PIPELINEDIR
cd $PIPELINEDIR
. $RP_PILOT_SANDBOX/env/rp_named_env.rp.sh || true
...
cd $BASEDIR
cp ./modules/kopp14/glaciers/cholcov.py ./modules/kopp14/glaciers/kopp14_glaciers_fit.py $PIPELINEDIR
cd $PIPELINEDIR
. $RP_PILOT_SANDBOX/env/rp_named_env.rp.sh || true
...
cd $BASEDIR
cp ./modules/kopp14/glaciers/AssignFP.py ./modules/kopp14/glaciers/ReadFingerprint.py ./modules/kopp14/glaciers/read_locationfile.py ./modules/kopp14/glaciers/kopp14_glaciers_postprocess.py ./modules-data/grd_fingerprints_data.tgz $PIPELINEDIR
cd $PIPELINEDIR
. $RP_PILOT_SANDBOX/env/rp_named_env.rp.sh || true
tar -xvf grd_fingerprints_data.tgz 2> /dev/null; rm grd_fingerprints_data.tgz
...
cd $BASEDIR
cp ./modules/kopp14/icesheets/AssignFP.py ./modules/kopp14/icesheets/ReadFingerprint.py ./modules/kopp14/icesheets/kopp14_icesheets_postprocess.py ./modules/kopp14/icesheets/SampleISDists.py ./modules/kopp14/icesheets/read_locationfile.py ./modules-data/grd_fingerprints_data.tgz $PIPELINEDIR
cd $PIPELINEDIR
. $RP_PILOT_SANDBOX/env/rp_named_env.rp.sh || true
tar -xvf grd_fingerprints_data.tgz 2> /dev/null; rm grd_fingerprints_data.tgz
...
cd $BASEDIR
cp ./modules/kopp14/sterodynamics/DriftCorr.py ./modules/kopp14/sterodynamics/readMarzeion.py ./modules/kopp14/sterodynamics/read_CSIRO.py ./modules/kopp14/sterodynamics/SmoothZOSTOGA.py ./modules/kopp14/sterodynamics/read_locationfile.py ./modules/kopp14/sterodynamics/IncludeModels.py ./modules/kopp14/sterodynamics/kopp14_oceandynamics_preprocess.py ./modules/kopp14/sterodynamics/IncludeDABZOSModels.py ./modules-data/kopp14_sterodynamics_data.tgz ./modules/kopp14/sterodynamics/Smooth.py $PIPELINEDIR
cd $PIPELINEDIR
. $RP_PILOT_SANDBOX/env/rp_named_env.rp.sh || true
...
cd $BASEDIR
cp ./modules/kopp14/landwaterstorage/read_locationfile.py ./modules/kopp14/landwaterstorage/kopp14_landwaterstorage_postprocess.py $PIPELINEDIR
cd $PIPELINEDIR
. $RP_PILOT_SANDBOX/env/rp_named_env.rp.sh || true
...
cd $BASEDIR
cp ./modules/kopp14/verticallandmotion/read_locationfile.py ./modules/kopp14/verticallandmotion/kopp14_verticallandmotion_postprocess.py $PIPELINEDIR
cd $PIPELINEDIR
. $RP_PILOT_SANDBOX/env/rp_named_env.rp.sh || true
...
cd $BASEDIR
cp ./modules/deconto16/AIS/ReadFingerprint.py ./modules/deconto16/AIS/read_locationfile.py ./modules/deconto16/AIS/AssignFP.py ./modules/deconto16/AIS/deconto16_AIS_postprocess.py ./modules-data/grd_fingerprints_data.tgz $PIPELINEDIR
cd $PIPELINEDIR
. $RP_PILOT_SANDBOX/env/rp_named_env.rp.sh || true
tar -xvf grd_fingerprints_data.tgz 2> /dev/null; rm grd_fingerprints_data.tgz
...
cd $BASEDIR
cp experiments/ar5k14.rcp85/workflows.yml ./modules/facts/total/total_workflow.py $PIPELINEDIR
cd $PIPELINEDIR
. $RP_PILOT_SANDBOX/env/rp_named_env.rp.sh || true
