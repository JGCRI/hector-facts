...
python3 fair_temperature_preprocess.py --scenario ssp245 --pipeline_id tlm.global.temperature.fair.temperature
...
cd $PIPELINEDIR
. $RP_PILOT_SANDBOX/env/rp_named_env.rp.sh || true
python3 fair_temperature_project.py --pipeline_id tlm.global.temperature.fair.temperature --nsamps 1
...
python3 tlm_sterodynamics_preprocess_thermalexpansion.py --scenario ssp245 --climate_data_file $SHARED/climate/tlm.global.temperature.fair.temperature_climate.nc --pipeline_id tlm.global.ocean.tlm.sterodynamics
...
cd $PIPELINEDIR
. $RP_PILOT_SANDBOX/env/rp_named_env.rp.sh || true
python3 tlm_sterodynamics_project.py --pipeline_id tlm.global.ocean.tlm.sterodynamics --nsamps 1 --scenario ssp245 --baseyear 2005 --pyear_start 2020 --pyear_end 2150 --pyear_step 10
