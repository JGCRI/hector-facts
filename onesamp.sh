...
python3 tlm_sterodynamics_preprocess_thermalexpansion.py --scenario ssp585 --climate_data_file $SHARED/climate/tlm.global.temperature.fair.temperature_climate.nc --pipeline_id tlm.global.ocean.tlm.sterodynamics
...
cd $PIPELINEDIR
. $RP_PILOT_SANDBOX/env/rp_named_env.rp.sh || true
python3 tlm_sterodynamics_project.py --pipeline_id tlm.global.ocean.tlm.sterodynamics --nsamps 1 --scenario ssp585 --baseyear 2005 --pyear_start 2020 --pyear_end 2150 --pyear_step 10
